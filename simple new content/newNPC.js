...
let myNpcSetting = {
    ...
    Tester : {
        ...
        loveInterest: ()=>{ return V.tester.humanity > 80 && V.tester.emotional > 60 && V.tester.desire > 10  } 
    ...
    Sampler : {
        important : ()=>{ return V.sampler.process > 50 }, // all those value can set as function check with conditions
        love : { displayname: ['Devotion', '忠诚'], requirements: ()=>{ return V.sample.condition > 50 } },
...
let myTraits = [

    {
        ...
        cond : ()=>{ return V.player.virginity.anal == true }, // the condition for get the trait
...

    {
        ...
        cond : ()=>{ return V.player.virginity.vaginal == true }, 
