...
class Pocket{
    ...
    constructor( type, position, limitsize ){
         ...
         * @returns {iStack | void}
         */
        this.takeSome = function(uid, num){
            const stack = this.get(uid)
            if(!stack){
                return
            }
         ...
         * @returns {iStack[]}
         */
        this.takeMulti = function(uid, num){
         ...
         */
        this.check = function(itemStacks){
